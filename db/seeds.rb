...
@bike1 = Bike.new(category: "Mountain", price_per_day: 15 , location: "Paris" , name: "Mountain bike", description: "With suspensions", model: "XB36 master", user_id: User.last.id)
...
@bike2 = Bike.new(category: "City", price_per_day: 20 , location: "London" , name: "City bike", description: "Electricity powered", model: "XB36 novice", user_id: User.last.id)
...
@bike1 = Bike.new(category: "Touring", price_per_day: 400 , location: "Paris" , name: "Tricycle bike", description: "Asymetry", model: "Tricycle bike", user_id: User.last.id)
...
@bike2 = Bike.new(category: "City", price_per_day: 29 , location: "Montmartre" , name: "Unicycle bike", description: "Unbalanced", model: "Unicycle bike", user_id: User.last.id)
...
@bike1 = Bike.new(category: "City", price_per_day: 36 , location: "Elysée" , name: "Supercycle", description: "Big", model: "Supercycle", user_id: User.last.id)
...
@bike2 = Bike.new(category: "Gravel", price_per_day: 34 , location: "Himalaya" , name: "Normal bike", description: "Unbalanced", model: "Normal bike", user_id: User.last.id)
...
@bike2 = Bike.new(category: "Gravel", price_per_day: 4 , location: "Himalaya" , name: "Velib normal", description: "Super lourd", model: "Velib normal", user_id: User.last.id)
